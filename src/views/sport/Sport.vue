...
<script>
import { sport_api } from "../../api/sport";
export default {
  name: "Sport",
  data() {
    return {
...
.sport .item_detail .list_image {
  margin-top: 12px;
}
.sport .item_detail .list_image .clearfix {
  font-size: 0;
  text-align: center;
}
.sport .item_detail .list_image .clearfix li {
...
.sport .item_detail .list_image .clearfix li:first-child {
  padding-right: 4px;
  float: left;
}
.list_image img {
...
.sport .item_detail .item_info span {
  margin-right: 10px;
  line-height: 24px;
  display: inline-block;
...
.sport .item_detail .image-margin-right {
  margin-right: 24px;
  line-height: 42px;
  font-size: 34px;
}
.sport .list_img_holder {
  overflow: hidden;
  width: 33%;
  display: inline-block;
  vertical-align: middle;
}
.sport .list_img_holder img {
  width: 100%;
}
</style>
